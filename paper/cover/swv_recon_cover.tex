...
\begin{center}
\large\bf Dr. Andria Dawson \\ % Your name
%\vspace{20pt} \hrule height 1pt % If you would like a horizontal line separating the name from the address, uncomment the line to the left of this text
367 Evans Hall \\ University of California, Berkeley\\ Berkeley, CA 94720 \\ (510) 705-3871 % Your address and phone number
\end{center} 
\vfill

\signature{Andria Dawson} % Your name for the signature at the bottom
