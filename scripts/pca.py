...
S1, T1, V1, E1, cols1 = pca(chrons, 1845, 1981, return_raw_scores=True)
S2, T2, V2, E2, cols2 = pca(chrons, 1750, 1981, return_raw_scores=True) 

print V1
print V2

S1tmp, _, _, _, _ = pca(chrons, 1845, 1981)
S2tmp, _, _, _, _ = pca(chrons, 1750, 1981)
...
# # print reconstruction statistics for first PCA

# print "mjPR stats for first PCA"
# stats1, stats2 = test_chron(chrons, 'mjPrecip', 1845, 1981, splice=False)
...
# print "jjPDSI stats for first PCA"
# stats1, stats2 = test_chron(chrons, 'jjPdsi', 1845, 1981, splice=False)
...
# # print reconstruction statistics for the 1750 - 1981 PCA

# print "mjPR stats for second PCA"
# stats1, stats2 = test_chron(chrons, 'mjPrecip', 1750, 1981, splice=False)
...
# print "jjPDSI stats for second PCA"
# stats1, stats2 = test_chron(chrons, 'jjPdsi', 1750, 1981, splice=False)
...
# # print reconstruction statistics for the spliced PCAs

# print "mjPR stats for spliced PCAs"
# stats1, stats2 = test_chron(chrons, 'mjPrecip', 1750, 1981, splice=True)
...
# print "jjPDSI stats for spliced PCAs"
# stats1, stats2 = test_chron(chrons, 'jjPdsi', 1750, 1981, splice=True)
